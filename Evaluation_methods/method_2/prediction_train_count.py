...
def pre_train(attribute_prediction,
    ...
    for epoch_index in range(start_epoch, num_epochs):
        train_loss = pre_train_epoch(attribute_prediction, train_data_x, train_data_y ,batch_size, optim)
...
def main():
    ...
    pre_train(attribute_prediction,
              data_x,
              data_y,
              output_path="/root/pytorch/Evaluation_models/prediction_count.torch"
              )
